...
public class ChoiceNumSigns2ButtonHandler implements Handlers {
    @Override
    public SendMessage sendMessage(Long userId) {
        SendMessage message = new SendMessage();
        message.setText("Ви обрали " + Buttons.SIGNS2.get() + " знака після коми:");
        ...
        InlineKeyboardButton sign2 = InlineKeyboardButton.builder().text(Icons.CHECK.get() + Buttons.SIGNS2.get()).callbackData(Buttons.SIGNS2.get()).build();
